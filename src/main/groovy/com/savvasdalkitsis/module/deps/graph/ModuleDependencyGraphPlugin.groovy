    ...
    void apply(Project project) {
        project.task('graphModules') {
            doLast {
                ...
                dotFile.write(dot)
                def autoGenerateDot = true
                if (project.hasProperty('autoGenerateDot')) {
                    autoGenerateDot = Boolean.parseBoolean(project.property('autoGenerateDot').toString())
                }
                if (autoGenerateDot) {
                    project.exec {
                        executable = "dot"
                ...
                if (autoGenerateDot && autoOpenGraph) {
